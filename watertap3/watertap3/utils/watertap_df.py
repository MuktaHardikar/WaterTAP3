...
def watertap_setup(dynamic=False, case_study=None, reference='nawi', scenario=None,
    ...
    def get_source(reference, water_type, case_study, scenario):
        ...
        '''
        input_file = '/Users/mhardika/Documents/watertap3/WaterTAP3/watertap3/watertap3/data/case_study_water_sources.csv'
...
def run_watertap3(m, desired_recovery=1, ro_bounds='seawater', solver='ipopt', 
                    return_df=False, tolerance=None, tee=False,treatment_df=None ):
    ...
    if m.fs.has_ro:
        ...
        if m.fs.new_case_study:
            ...
            m = watertap_setup(dynamic=False, case_study=case_study, scenario=scenario, new_df_units=new_df_units,treatment_df=treatment_df)
            ...
            m = watertap_setup(dynamic=False, case_study=case_study, scenario=scenario,treatment_df=treatment_df)
