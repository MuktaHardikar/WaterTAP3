...
def watertap_setup(dynamic=False, case_study=None, reference='nawi', scenario=None,
                   ...
                   treatment_file_path='data/treatment_train_setup.csv'):
...
def run_watertap3(m, desired_recovery=1, ro_bounds='seawater', solver='ipopt', 
                    return_df=False, tolerance=None, tee=False,treatment_file_path='data/treatment_train_setup.csv'):
    ...
    if m.fs.has_ro:
        ...
        if m.fs.new_case_study:
            ...
            m = watertap_setup(dynamic=False, case_study=case_study, scenario=scenario, new_df_units=new_df_units,treatment_file_path=treatment_file_path)
            ...
            m = watertap_setup(dynamic=False, case_study=case_study, scenario=scenario,treatment_file_path=treatment_file_path)
